...
# Split the image to 5000 cells, each 20x20 size according the image
...
# Spliting the full data set into two segments
...
# Initiate kNN, training the data, then testing it with test data for k=3
knn = cv2.KNearest()
...
# Bluring image then find edges using Canny 
...
#Sorting out contours left to right by using their x cordinates
contours = sorted(contours, key = x_cord_contour, reverse = False)

# Creating empty array to store entire number
full_number = []
